...
### What credential testing means here

✅ **Allowed**: try a list of user:pass combinations against
SSH / RDP / FTP / MySQL / Redis / SMB / etc. via the standard
authentication handshake.

✅ **On hit**: write `user / pass` to `creds.txt` and stop.
...
❌ **Never**: any post-auth action — running remote commands,
