...
// loading its bbolt seen-set. Forces --resume=true and requires --project <name>.
//
...
--project <name> to identify the project. Equivalent to:

  fg-qimen --project <name> -H ... -r`,
	RunE: func(cmd *cobra.Command, args []string) error {
		if flagProject == "" {
			return fmt.Errorf("resume requires --project <name> to identify the project workspace")
		}
		// Force resume mode regardless of caller-supplied -r value.
		// 无论调用方是否传了 -r，都强制开启。
		flagResume = true
