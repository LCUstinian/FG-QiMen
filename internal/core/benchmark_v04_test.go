...
// mockPluginBV04 was removed — the benchmark suite exercises
// real plugins, not mocks. / mockPluginBV04 已删除——基准测试
// 套件测真实 plugins，不用 mock。

// suppress unused warning for testing.TB. / 抑制 unused。
var _ = time.Now
