...
var RuleDatas = []RuleData{
	...
	// ─── Phase 1.7 expansion: more common CMS / frameworks / OS ───
	// ─── Phase 1.7 扩展：更多常见 CMS / 框架 / 操作系统 ───
	{Name: "WordPress", Type: "code", Rule: "(wp-content/|wp-includes/|wp-json)"},
	...
	{Name: "Ghost", Type: "code", Rule: "(ghost-url|/ghost/api)"},
	{Name: "Hugo", Type: "code", Rule: "(<meta name=\"generator\" content=\"Hugo)"},
	{Name: "Jekyll", Type: "code", Rule: "(<meta name=\"generator\" content=\"Jekyll)"},
	{Name: "Hexo", Type: "code", Rule: "(<meta name=\"generator\" content=\"Hexo)"},
	{Name: "Vue-Press", Type: "code", Rule: "(VuePress)"},
	{Name: "Vue", Type: "code", Rule: "(<div id=\"app\"|__VUE__)"},
	{Name: "React", Type: "code", Rule: "(react-root|_react)"},
	{Name: "Next.js", Type: "code", Rule: "(_next/static|NEXT_DATA)"},
	{Name: "Nuxt.js", Type: "code", Rule: "(__nuxt|_nuxt/)"},
	{Name: "Angular", Type: "code", Rule: "(ng-version|angular)"},
	{Name: "Express", Type: "headers", Rule: "(X-Powered-By: Express)"},
	{Name: "Django", Type: "cookie", Rule: "(csrftoken|django)"},
	{Name: "Flask", Type: "headers", Rule: "(Server: Werkzeug)"},
	{Name: "Laravel", Type: "cookie", Rule: "(laravel_session|XSRF-TOKEN)"},
	{Name: "Spring", Type: "code", Rule: "(<link[^>]*href=\"[^\"]*\\.do\\?)|Whitelabel Error Page)"},
	{Name: "Tomcat", Type: "headers", Rule: "(Server: Apache-Coyote|X-Powered-By: Servlet)"},
	{Name: "Nginx", Type: "headers", Rule: "(Server: nginx)"},
	{Name: "Apache", Type: "headers", Rule: "(Server: Apache)"},
	{Name: "IIS", Type: "headers", Rule: "(Server: Microsoft-IIS|X-Powered-By: ASP\\.NET)"},
	{Name: "Lighttpd", Type: "headers", Rule: "(Server: lighttpd)"},
	{Name: "Caddy", Type: "headers", Rule: "(Server: Caddy)"},
	{Name: "Nginx-Proxy", Type: "headers", Rule: "(X-Forwarded-For: .*nginx|X-Nginx)"},
	{Name: "Cloudflare", Type: "headers", Rule: "(cf-ray|cf-cache-status|server: cloudflare)"},
	{Name: "Akamai", Type: "headers", Rule: "(x-akamai|akamai)"},
	{Name: "Fastly", Type: "headers", Rule: "(x-fastly|X-Served-By: cache-.*fastly)"},
	{Name: "Varnish", Type: "headers", Rule: "(X-Varnish|via: varnish)"},
	{Name: "Squid", Type: "headers", Rule: "(X-Squid|via: .*squid)"},
	{Name: "HAProxy", Type: "headers", Rule: "(X-Haproxy|haproxy)"},
	{Name: "AWS-ALB", Type: "headers", Rule: "(X-Amzn-Trace-Id|awselb)"},
	{Name: "ELB", Type: "headers", Rule: "(elb.amazonaws.com)"},
	{Name: "Azure-AppGW", Type: "headers", Rule: "(X-Azure-RequestChain|AppGw-Trace-Id)"},
	{Name: "Kestrel", Type: "headers", Rule: "(Server: Kestrel)"},
	{Name: "Jetty", Type: "headers", Rule: "(Server: Jetty)"},
	{Name: "Wildfly-JBoss", Type: "headers", Rule: "(X-Powered-By: JBoss|WildFly)"},
	{Name: "GlassFish", Type: "headers", Rule: "(Server: GlassFish)"},
	{Name: "WebLogic-Server", Type: "headers", Rule: "(Server: WebLogic)"},
	{Name: "WebSphere", Type: "headers", Rule: "(Server: WebSphere)"},
	{Name: "ASP.NET", Type: "headers", Rule: "(X-AspNet-Version|X-Powered-By: ASP\\.NET)"},
	{Name: "PHP", Type: "headers", Rule: "(X-Powered-By: PHP)"},
	{Name: "NextAuth", Type: "cookie", Rule: "(next-auth\\.csrf|__Secure-next-auth)"},
	{Name: "Strapi", Type: "code", Rule: "(/admin strapi|strapi-admin)"},
	{Name: "Ghost-CMS", Type: "code", Rule: "(/ghost/api/|ghost-foot)"},
	{Name: "Keycloak", Type: "code", Rule: "(/auth/realms/|keycloak)"},
}
